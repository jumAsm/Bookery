...
List<BookModel> initialBookData = [
  ...
  BookModel(
    ...
    description: "تحكي الرواية حكايتين متوازيتين: الأولى عن كافكا تامورا، فتى يهرب من منزل أبيه بسبب نبوءة مظلمة، والثانية عن ناكاتا، رجل عجوز فقد ذاكرته ويستطيع التحدث مع القطط. تتقاطع القصتان في عالم يمزج بين الواقع والخيال، حيث يبحث الأبطال عن ذواتهم ومعنى القدر والحب والحرية.",
    rating: "4.6",
    coverUrl:
