...
List<BookModel> initialBookData = [
  ...
  BookModel(
    ...
    rating: "4.3",
    coverUrl:
    "https://i.pinimg.com/1200x/62/ae/d8/62aed8a0b105b2d0ccdcf98c341f0f0e.jpg",
    bookurl: "placeholder_7.pdf",
    category: "Fantasy",
    language: "English",
    createdAt: DateTime.now().toString(),
  ...
  BookModel(
    ...
    description: "What influences led to the creation of civilization? Why and how did it come to be? What determines civilization’s trajectory? Freud’s theories on the effect of the knowledge of death on human existence and the birth of art are central to his work. Of the various English translations of Freud’s major works to appear in his lifetime, only Norton’s Standard Edition, under the general editorship of James Strachey, was authorized by Freud himself.",
    rating: "4.5",
    coverUrl:
    "https://i.pinimg.com/1200x/60/47/d9/6047d991aedacdfa39a9e007da52abd7.jpg",
    bookurl: "placeholder_3.pdf",
    category: "Psychology",
    language: "English",
    createdAt: DateTime.now().toString(),
